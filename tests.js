 ...
 *  Step 2: Copy/Paste your debugged code from JS6Lab.js into the describe block 
 * (exclude the final console.log())
 *  Step 3: Create tests using expect/assert to test for expected outputs.
 *  Use multiple cases.
...
describe('Question 1c: Get day of the week.', () => {
  ...
  it('#Should return the day of the week, Wednesday', () => {

    expect(dayOfTheWeek(3)).to.equal('Wednesday')
  })

  it('#Should return the day of the week, Monday', () => {
